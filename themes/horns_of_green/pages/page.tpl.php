  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box || $primary_links || $secondary_links || $navbar) { print ' with-navbar'; } ?>">
      ...
      <div id="content"><div id="content-inner">
        ...
        <?php 
	   if ( empty($node) ){
		$node = node_load(array("nid" => 190));
	   }
	?>            
        <img src="/sites/all/themes/horns_of_green/images/pageHeaders/<?php if($node->type == 'blog') { print 'pageHeader_blogPost.jpg'; }
		  	elseif ($node->type == 'general_resource' || $node->type == 'incubator' || $node->type == 'article_post' || $node->type == 'blog_media') { print 'pageHeader_resourceInfo.jpg';  }
			elseif ($node->type == 'announcement') { print 'pageHeader_news.jpg';  }
			elseif ($node->type == 'event' || $node->type == 'be_calendar_event' || $node->type == 'betahouse_event') { print 'pageHeader_EventDetails.jpg';  }
			elseif ((strpos($body_classes, 'blog-categories'))) { print 'pageHeader_blog.jpg';  }
			elseif ((strpos($node->path, 'add'))) { print 'pageHeader_addContent.jpg';  }
			elseif ($node->path == 'resources') { print 'pageHeader_resourceCenter.jpg';  }
			elseif ((strpos($uri, '/guides'))) { print 'pageHeader_greenhornGuides.jpg';  }
			elseif ((strpos($uri, '/careers'))) { print 'pageHeader_career.jpg';  }
			elseif ((strpos($uri, 'greenhornconnect.com/about'))) { print 'pageHeader_about.jpg'; }
			elseif ((strpos($uri, 'greenhornconnect.com/students/programs'))) { print 'pageHeader_students.jpg'; }
			else { print 'pageHeader_default.jpg'; } ?>" />
