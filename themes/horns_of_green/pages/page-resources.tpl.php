  ...
  <div id="page"><div id="page-inner">
        ...
        <div id="header-top" class="clear-block">
          ...
          <?php else: ?>
          	<div id="header-top-user-info">
          		<a href="/users/<?php print $user->name; ?>">My Account</a> | 
    ...
    <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box || $primary_links || $secondary_links || $navbar) { print ' with-navbar'; } ?>">
      ...
      <div id="content"><div id="content-inner">
        ...
        <img src="/sites/all/themes/horns_of_green/images/pageHeaders/pageHeader_resourcesAll.jpg" />
      ...
      <?php if ($right): ?>
        <div id="sidebar-right"><div id="sidebar-right-inner" class="region region-right">
        	<div id="sidebar-add-resource-button">
         	<a href="/resources/add" title="Add a resource"><img src="/sites/all/themes/horns_of_green/images/btn/btn_CTA_addResource.jpg" /></a>
         </div>
          <?php print $right; ?>
