...
<head>
<title>Boston entrepreneur jobs, events, resources and blog | Greenhorn Connect</title>
...
<div id="page">
  <div id="page-inner"> <a name="navigation-top" id="navigation-top"></a>
      ...
      <div id="main-inner" class="clear-block<?php if ($search_box || $primary_links || $secondary_links || $navbar) { print ' with-navbar'; } ?>">
        <div id="content">
          <div id="content-inner">
            ...
            <?php endif; ?>
            <!-- /#content-header -->
            <div id="content-area" class="<?php if($tabs) { print ' with-tabs'; } ?>"> <?php print $content; ?> </div>
            <?php if ($feed_icons): ?>
        ...
        <?php /*?><?php if ($search_box || $primary_links || $secondary_links || $navbar): ?>
      ...
      <?php endif; ?><?php */?>
        ...
        <div id="sidebar-right">
          <div id="sidebar-right-inner" class="region region-right">
            <div id="join-community-image-button"> <a href="/user/register" title=""><img src="/sites/all/themes/horns_of_green/images/btn/btn_CTA_joinCommunity.jpg" /></a> </div>
            <?php print $right; ?> </div>
        </div>
    ...
    <!-- /#main-inner, /#main -->
    <?php /*?><?php if ($footer || $footer_message): ?>
