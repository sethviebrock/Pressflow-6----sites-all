...
<head>
  ...
  <meta name="keywords" content="entrepreneur, entrepreneurial, boston, resources, events, entreprenuer events, young entrepreneurs, getting started, boston entrepreneur, boston startup, startup, startups" />
  <?php print $head; ?>
  <?php print $styles; ?>
  <?php print $scripts; ?>
</head>
...
<div id="content"><div id="content-inner">
        ...
        <?php endif; ?>
	  <div id="job-board-menu" class="block-ajax_register">
            <?php 

		if($user->uid && $user->uid != 0){
		  print theme('links', menu_navigation_links('menu-job-board-menu')); 
		}
		else {
                  print '<ul><li>' . l(
			t('Post a job'), 
			'ajax_register/login/jobboard',
			array('query' => array(destination => 'node/add/job-post'), 'attributes' => array('class' => 'thickbox initThickbox-processed post-a-job'))
		  	)
		  . '<span class="info"><a class="colorbox-load" href="http://www.screenr.com/embed/oTX?width=650&height=396&iframe=true#player">
			<img src="/' . path_to_theme() . '/img/question.png">
		    </a></span>'  
		  . '</li></ul>';
		}
	    ?>
        ...
        <?php if ($left_adspace || $right_adspace): ?>
        	<div id="ads">
            	<div class="right_adspace adspace_450x150">
                    <div class="ad_450x150"><?php print $right_adspace; ?></div>
                </div>
                <div class="left_adspace adspace_450x150">
                    <div class="ad_450x150"><?php print $left_adspace; ?></div>
                </div>
            </div>
        <?php endif; ?>
...
<div id="footer">
  ...
  <?php /*?><?php if ($closure_region): ?><?php */?>
    <div id="closure-blocks" class="region region-closure">
		<?php print $closure_region; ?>
    	<!--<script type="text/javascript">
var scripturl = (("https:" == document.location.protocol) ? "https://" : "http://") + "lytiks.conversionassociates.com/content/WebTrack/catracker.js";
document.write(unescape("%3Cscript src='" + scripturl + "' type='text/javascript'%3E%3C/script%3E"));
</script>
<script type="text/javascript">
    try {
    var cat = new CATracker("0f30cb58-00fe-4ab4-8daf-63d0b3caff93");
...
<!--<noscript><img src='http://lytiks.conversionassociates.com/content/WebTrack/track.gif?noscript=1&aweid=0f30cb58-00fe-4ab4-8daf-63d0b3caff93&action=PageView'/></noscript>-->
